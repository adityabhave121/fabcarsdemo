...
class CarsYouMayLike extends React.Component<Props & ReduxProps, State> {
  render() {
    return (
      <Row
        style={{ height: "300px", marginTop: "5%", backgroundColor: "#F5F5F5" }}
      >
        <Col span={24}>
          <Title level={2}>Cars You May Like</Title>
        </Col>
      </Row>
    );
  }
